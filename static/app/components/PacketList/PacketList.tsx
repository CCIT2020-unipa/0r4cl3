...
export class PacketList extends React.PureComponent<IProps> {
  render(): JSX.Element {
    const { height, packets, onRowPress } = this.props
  ...
  private computeColumns = (): ColumnsType<IPacketNoPayload> => {
